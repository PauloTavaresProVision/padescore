...
function Toggle({
  ...
  return (
    <label className="flex cursor-pointer items-start gap-3 rounded-xl border border-slate-200 bg-slate-50 p-4 transition hover:border-slate-300 hover:bg-slate-100">
      ...
      />
      <span
        className="relative mt-0.5 inline-block h-5 w-9 shrink-0 rounded-full bg-slate-300 transition before:absolute before:left-0.5 before:top-0.5 before:h-4 before:w-4 before:rounded-full before:bg-white before:shadow-sm before:transition peer-checked:bg-emerald-500 peer-checked:before:translate-x-4"
      />
