    ...
    <div className="flex min-h-dvh">
      ...
      <aside className="sticky top-0 hidden h-dvh w-64 shrink-0 flex-col border-r border-slate-800/80 bg-slate-950/80 backdrop-blur-xl lg:flex">
        <div className="px-6 py-6">
          <Link href="/admin" className="flex items-center gap-2 text-lg font-semibold tracking-tight">
            <span className="grid h-8 w-8 place-items-center rounded-lg bg-gradient-to-br from-emerald-400 to-cyan-500 text-slate-950">
              P
            </span>
            <span>Padescore</span>
          </Link>
      ...
      <header className="sticky top-0 z-30 flex w-full items-center justify-between border-b border-slate-800 bg-slate-950/90 px-4 py-3 backdrop-blur lg:hidden">
        <Link href="/admin" className="flex items-center gap-2 text-base font-semibold">
          <span className="grid h-7 w-7 place-items-center rounded-md bg-gradient-to-br from-emerald-400 to-cyan-500 text-slate-950">
            P
          </span>
          Padescore
        </Link>
